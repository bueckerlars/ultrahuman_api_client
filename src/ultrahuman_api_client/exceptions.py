...
class UltrahumanAPINotFoundError(UltrahumanAPIError):
    ...
    def __init__(self, message: str = "Resource not found. User may not exist or data sharing permission may be missing."):
...
class UltrahumanAPIInternalServerError(UltrahumanAPIError):
    ...
    def __init__(self, message: str = "Internal server error. Something went wrong on Ultrahuman's end."):
